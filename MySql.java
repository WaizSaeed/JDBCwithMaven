...
// Connection c=DriverManager.getConnection("jdbc:mysql://localhost/jdbcmaven", "jdbcmaven1", "jdbcmaven2");
Connection c=DriverManager.getConnection("jdbc:mysql://localhost:3306/jdbcmaven1", "jdbcmaven2", "jdbcmaven3");	
String t1="lalu";
int t2=420;
